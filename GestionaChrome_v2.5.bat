...
:: Titol sense caracters especials per evitar errors de lectura del fitxer
title GestionaChrome v2.5
...
set "scriptName=GestionaChrome_v2.5.ps1"
...
echo ==========================================
echo       Iniciant GestionaChrome v2.0
echo ==========================================
echo.
